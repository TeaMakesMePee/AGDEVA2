...
{
	std::cout << "======================================================================" << std::endl;
	std::cout << "CSceneNode::PrintSelf" << std::endl;
	std::cout << "----------------------------------------------------------------------" << std::endl;
	std::cout << "a[\t" << a[0] << "\t" << a[4] << "\t" << a[8] << "\t" << a[12] << "\t]" << std::endl;
	std::cout << "a[\t" << a[1] << "\t" << a[5] << "\t" << a[9] << "\t" << a[13] << "\t]" << std::endl;
	std::cout << "a[\t" << a[2] << "\t" << a[6] << "\t" << a[10] << "\t" << a[14] << "\t]" << std::endl;
	std::cout << "a[\t" << a[3] << "\t" << a[7] << "\t" << a[11] << "\t" << a[15] << "\t]" << std::endl;
	std::cout << "======================================================================" << std::endl;
}
